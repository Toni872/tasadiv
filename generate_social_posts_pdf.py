...
POSTS = [
    ...
    (
        "Miércoles · 8:00 – 9:00 AM (Twitter/X)",
    ...
    (
        "Miércoles · 12:00 – 1:00 PM (LinkedIn)",
...
for title, body in POSTS:
    pdf.add_page()
    pdf.set_font("SegoeEmoji", size=16)
    pdf.multi_cell(0, 10, title)
    pdf.ln(2)
    pdf.set_font("SegoeEmoji", size=11)
